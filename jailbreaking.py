...
parser.add_argument('--target-model', dest='target_model', choices=['TinyLlama-1.1B-lora', 'gpt-3.5-turbo-0125', 'gpt-4-0125-preview', 'claude-3-5-sonnet-20241022', 'llama-2-7b', 'llama-2-13b', 'mistral-7b-v0.2'])
parser.add_argument('--check-method', dest='check_method', default='key_words', choices=['key_words', 'gpt', 'multilingual'], help='The methods of checking if the jailbreak succeed')
